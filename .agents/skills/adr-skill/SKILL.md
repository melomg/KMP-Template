---
name: adr-skill
description: Creates Architecture Decision Records (ADRs) with structured formatting optimized for AI consumption and human readability.
---
...
If an ADR is for frontend, it must be saved in `docs/adr/frontend/`.
If an ADR is for backend, it must be saved in `docs/adr/backend/`.
...
2. https://github.com/github/awesome-copilot/blob/f503ffa543fbfbf78fd065fb72d36f1c6bc37d0d/agents/adr-generator.agent.md
3. https://mcpmarket.com/tools/skills/architecture-agent
4. https://github.com/skillrecordings/adr-skill/tree/main